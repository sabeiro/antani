...
<script nonce="yhR8YEg6V//rJQ7rRYeiyQ==">
//<![CDATA[
...
<meta name="csrf-token" content="nIhwgDC1EC7pQkftg3Jh2S08rqxDTmesmU+9XgCoiHEUQm1+P8MApTXmULk5/XRu/dOKLii3eL460XZcl/pGTA==" />
<meta name="csp-nonce" content="yhR8YEg6V//rJQ7rRYeiyQ==" />
...
<form class="new_user gl-show-field-errors" id="new_user" aria-live="assertive" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="z6w88A2UJJrueZL4X8ut39aRd8a2qjkw1nnHRTzAejlHZiEOAuI0ETLdhazlRLhoBn5TRN1TJiJ15wxHq5K0BA==" /><div class="form-group">
...
<div class="login-body">
<form class="new_new_user gl-show-field-errors" id="new_new_user" aria-live="assertive" action="/users" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="CKfJBHTCtzd7nwidFUJmXVk+sZjQ2ufzUm1Y32ia7DqAbdT6e7SnvKc7H8mvzXPqidGVGrsj+OHx85Pd/8giBw==" /><div class="devise-errors">
