...
<meta name="csrf-token" content="uyQPulaNVbBZNIerzzvGLVXp+Tpmbt6P470b5vhGmgAluWAzdhxbmcgE+ncn5G45xhSkfXkUfFY3mS9xeClkAA==" />
<meta name="csp-nonce" content="e6PrN5D2Uxu4sR6ZJI727g==" />
...
<form class="new_user gl-show-field-errors" id="new_user" aria-live="assertive" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="UGBPSTK7y6gOnBdFU9IIp9oo9NnUmztQ+slyv1SR623O/SDAEirFgZ+sapm7DaCzSdWpnsvhmYku7UYo1P4VbQ==" /><div class="form-group">
...
<div class="login-body">
<form class="new_new_user gl-show-field-errors" id="new_new_user" aria-live="assertive" action="/users" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="cAaVEkyPJ02Gk5NZQfhtGnl6Gu4nZFO2neeJo9LRIkbum/qbbB4pZBej7oWpJ8UO6odHqTge8W9Jw700Ur7cRg==" /><div class="devise-errors">
